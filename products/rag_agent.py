...
def build_products_retriever_tool(retriever):

    @tool
    def products_retriever_tool(query: str) -> str:
        """
    ...
    return products_retriever_tool
...
class RAGAgentBuilder:
    ...
    def build_agent(self):
        ...
        products_tool = build_products_retriever_tool(retriever)
